...
public abstract class Constantes {
    ...
    public static float capaciteMax = -1;
    public static float dureeMaxTournee = -1;
    
    public static float dureePark = -1;
    public static float dureePickup = -1;
    public static float dureeSwap = -1;
